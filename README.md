...
- **Kubernetes**: reusable workload and resource templates such as Deployments, Services, Ingresses, external secret references, and more.
...
Boilerplates supports seven variable types:

- `str` — text
- `int` — whole number
- `float` — decimal number
- `bool` — true/false
- `enum` — one value from configured options
