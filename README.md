...
Boilerplates supports eight variable types:
...
- `secret` — selected or autogenerated Secret reference

Defaults must match the declared variable type, and `secret` variables cannot define defaults. See the [canonical template variable reference](https://github.com/christianlempa/boilerplates/blob/main/docs/features/templates/templates-variables.md) for the complete schema and rendering behavior.
